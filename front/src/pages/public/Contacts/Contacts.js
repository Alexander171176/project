...
export default function Contacts() { // компонент страницы Договор оферты
                                ...
                                <div className="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0">
                                    <form>
                                        ...
                                        <div className="form-group form-check text-center mb-6">
                                            ...
                                            <label className="form-check-label inline-block text-gray-800  dark:text-gray-700" for="exampleCheck87">Пришлите мне копию этого сообщения</label>
                                        </div>
                                        <button
                                            type="submit"
